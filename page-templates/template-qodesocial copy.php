<?php /* Template Name: qode social2 */ ?>
...
<main class="inner-page">
    ...
    <section class="badgesz">
        <div class="container">
            <div class="row justify-content-center align-items-center text-center">
                ...
                <div class="col-lg-2 col-sm-12">
                    <img class="" alt=""
                        src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/inner-page/Instagram.png" />
                </div>
                <div class="col-lg-2 col-sm-12">
                    <img class="" alt=""
                        src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/inner-page/Hootsuite.png" />
                </div>
                <div class="col-lg-2 col-sm-12">
                    <img class="" alt=""
                        src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/inner-page/Google-Ads.png" />
                </div>
                <div class="col-lg-2 col-sm-12">
                    <img class="" alt=""
                        src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/inner-page/Google-Partners.png" />
                </div>
                <div class="col-lg-2 col-sm-12">
                    <img class="" alt=""
                        src="<?php echo get_stylesheet_directory_uri() ?>/assets/images/inner-page/BBB.png" />
                </div>
            </div>
        </div>
    ...
    <section class="content-creationz">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-sm-12">
    ...
    <!-- ========== Start Packages ========== -->
    <section class="packagesz">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 col-sm-12">
                    <p class="titlez">Pick the best plan for you</p>
                    <p>Prepackaged goods for the modern age. Choose a package, or contact us for more options</p>
                </div>
                <div class="col-lg-6 col-sm-12">
